...
%%
figure(1);
semilogy(EbN0dB,symErrSimulatedqam(1,:),'-d','LineWidth',2);
hold on;
semilogy(EbN0dB,symErrSimulatedqam(2,:),'--','LineWidth',2);
semilogy(EbN0dB,symErrSimulatedqam(3,:),'-o','LineWidth',2);
semilogy(EbN0dB,symErrSimulatedqam(4,:),'-p','LineWidth',2);
semilogy(EbN0dB,symErrSimulatedqam(5,:),'-.s','LineWidth',2);
semilogy(EbN0dB,symErrSimulatedqam(6,:),'-','LineWidth',2);
xlabel('E_b/N_0(dB)');
ylabel('BER');
title(['BER For 16QAM Under Rician Fading Environment']);
grid on;
