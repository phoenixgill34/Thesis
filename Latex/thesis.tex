...
\usepackage{verbatim,amssymb,amsmath,subfig}
\usepackage{float}
\usepackage{cite}
\usepackage{url}
...
\title{\scshape \mbox{Implementation of 5G Technologies with}\\
\scshape \mbox{Heterogeneous Cooperative Spectrum Sensing and LTE-R}}
